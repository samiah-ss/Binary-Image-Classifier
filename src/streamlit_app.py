...
st.write("Received a fishy email? Suspect a PDF to be malicious? This model detects whether or not binary images are malware. Convert your file to a malware binary visualization image. Then upload it here to check if it is benign or malicious.")
...
st.write(
    "_The core model was presented by Samiah Siddiqua alongside Jihyun Jeong, Polly Pao, and Jahnavi Gupta "
